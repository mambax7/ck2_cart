...
$Config['UserFilesPath'] = XOOPS_URL."/uploads/{$mdir}/{$uid}/" ;
///$Config['UserFilesPath'] = "http://192.168.1.183/uploads/tadnews/" ;
...
$Config['UserFilesAbsolutePath'] = XOOPS_ROOT_PATH."/uploads/{$mdir}/{$uid}/" ;
