...
FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','TextColor','BGColor']
] ;

FCKConfig.ToolbarSets["my"] = [
	['Source','Cut','Copy','Paste','Undo','Redo','Image','ImageManager','Flash','Table','Rule','Link','OrderedList','UnorderedList','summary','StrikeThrough','RemoveFormat'],
	'/',
	['FontFormat','FontSize','TextColor','BGColor','Bold','Italic','Underline','JustifyLeft','JustifyCenter','JustifyRight','Indent'],
] ;
...
FCKConfig.LinkUploadAllowedExtensions	= ".(odt|pdf|doc|rar|zip|ppt|sxw|7z|exe|txt)$" ;			// empty for all
